...
def detect(save_img=False,save_imgagnostic_nms=False,augment=False, classes=None, conf_thres=0.25, device='', exist_ok=False, img_size=640, iou_thres=0.45, name='exp', nosave=False, project='runs/detect', save_conf=False, save_txt=False, source='data/images', update=False, view_img=False, weights='yolov5wqx/weights/best.pt'):
    # parser = argparse.ArgumentParser()
    # parser.add_argument('--weights', nargs='+', type=str, default='yolov5wqx/weights/best.pt', help='model.pt path(s)')
    ...
    return save_dir,imageDes


if __name__ == '__main__':
    
    print("输出信息=",detect(source="0",weights='yolov5wqx/weights/best.pt',save_img=False))
